...
class GenerateServices
{
    ...
    private function fetchPromptImage($artikel)
    {
        ...
        $prompt = "Temukan dan informasikan kepada saya nama orang atau nama tempat atau nama peralatan atau nama organisasi dari '{$artikel->paragraf1}', '{$artikel->paragraf2}', '{$artikel->paragraf3}', '{$artikel->paragraf4}', sajikan dalam bentuk JSON dengan struktur berikut: { \"entities\": [\"\", \"\", \"\", \"\", \"\"] } tanpa ada teks tambahan lain.";
        $response = $api->post('/api/generate/text', $prompt);
