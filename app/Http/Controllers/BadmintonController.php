...
class BadmintonController extends Controller
{
    ...
    {
        $categories = Categories::where('name', 'badminton')
            ->orWhere('name', 'Badminton')
            ->first();
    ...
    public function viewAll(Request $request){
        $categories = Categories::where('name', 'badminton')->orWhere('name', 'Badminton')->first();
        // Data Artikel
    ...
    public function viewRecommendation(Request $request) {
        ...
        return view('badminton.viewrecommendation', [
            'recommendations' => $recommendations
        ]);
    }
}
