...
class BasketController extends Controller
{
    ...
    {
        $categories = Categories::where('name', 'basket')
            ->orWhere('name', 'Basket')
            ->first();
    ...
    public function viewAll(Request $request){
        $categories = Categories::where('name', 'basket')->orWhere('name', 'Basket')->first();
    ...
    public function viewHighlight(Request $request){
        ...
        return view('basket.viewhighlight', [
            'articles' => $articles
        ]);
    }
    ...
    public function viewRecommendation(Request $request) {
        ...
        return view('basket.viewrecommendation', [
            'recommendations' => $recommendations
        ]);
    }
}
