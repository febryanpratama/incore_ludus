                ...
                <div class="col-lg-3 col-md-3 col-sm-6 mt-3">
                    <div class="card h-100 d-flex flex-column">
                            ...
                            <div class="card-body">
                                ...
                                @if($article->type=='series')
                                <a href="{{route('basket.series', $article->slug)}}" class="badge text-bg-success">{{$article->type}}</a>
                                @else
                                <a href="{{route('basket.show', $article->slug)}}" class="badge text-bg-success">{{$article->type}}</a>
                                @endif
                                ...
                                @if($article->type=='series')
                                <h5 class="card-title"><a href="{{route('basket.series', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                                @else
                                <h5 class="card-title"><a href="{{route('basket.show', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                                @endif
        ...
        <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            @else 
                ...
                <div class="caption" style="margin-top: -25%; margin-left: 5%;">
                    ...
                    <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.series', $highlightPost->slug)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                    @else
                    <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.show', $highlightPost->slug)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                    @endif
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach($sideHighlight as $sh)
                            ...
                            <li class="list-group-item">
                                ...
                                @if($sh->type=='series')
                                <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.series', $sh->slug)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                                @else
                                <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.show', $sh->slug)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                                @endif
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card h-100 d-flex flex-column">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.series', $trending->slug)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.show', $trending->slug)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                            @endif
