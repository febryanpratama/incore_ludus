            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <p class="fs-5 text-muted mt-3">EXPLORE NEWS ABOUT basketball ON LUDUS. YOU'LL GET THE LATEST INFORMATION HERE.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <p class="responsive-text text-uppercase">About Basketball News</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
  ...
  <div class="container-fluid">
    <div class="row w-100">
        ...
        <div class="col-3 col-md-2 col-sm-3">
            <a href="{{ route('basket.viewall') }}" type="button" class="btn btn-outline-dark p-1">View All</a>
        </div>
    </div>
  </div>
</nav>
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    <div class="row w-100 mt-4">
        ...
        <div class="col-3 col-md-2 col-sm-3">
            <a href="{{ route('basket.viewhighlight') }}" type="button" class="btn btn-outline-dark p-1">View All</a>
        </div>
    </div>
  </div>
</nav>
    ...
    <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            <div class="caption" style="margin-top: -25%; margin-left: 5%;">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.series', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.show', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
  ...
  <div class="container-fluid mt-4">
    <div class="row">
        ...
        <div class="col-4 col-md-4 col-sm-3">
            <a href="{{ route('basket.viewrecommendation') }}" type="button" class="btn btn-outline-dark p-1">View All</a>
        </div>
    </div>
  </div>
</nav>
