    ...
    <div class="row">
        <div class="col-7">
            ...
            <div class="caption">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('basket.series', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('basket.show', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            @if($sh->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.series', $sh->id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.show', $sh->id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @endif
            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.series', $trending->id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('basket.show', $trending->id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @endif
