            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <p class="responsive-text text-uppercase">About Taekwondo News</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
  ...
  <div class="container-fluid">
    <div class="row w-100">
        ...
        <div class="col-3 col-md-2 col-sm-3">
            <a href="{{ route('taekwondo.viewall') }}" type="button" class="btn btn-outline-dark p-1">View All</a>
        </div>
    </div>
  </div>
</nav>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 mt-3">
                    <div class="card h-100 d-flex flex-column">
                            ...
                            <div class="card-body">
                                ...
                                @if($article->type=='series')
                                <a href="{{route('taekwondo.series', $article->slug)}}" class="badge text-bg-success">{{$article->type}}</a>
                                @else
                                <a href="{{route('taekwondo.show', $article->slug)}}" class="badge text-bg-success">{{$article->type}}</a>
                                @endif
                                ...
                                @if($article->type=='series')
                                <h5 class="card-title"><a href="{{route('taekwondo.series', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                                @else
                                <h5 class="card-title"><a href="{{route('taekwondo.show', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                                @endif
        ...
        <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            @else 
                ...
                <div class="caption" style="margin-top: -25%; margin-left: 5%;">
                    ...
                    <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.series', $highlightPost->slug)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                    @else
                    <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.show', $highlightPost->slug)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                    @endif
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach($sideHighlight as $sh)
                            ...
                            <li class="list-group-item">
                                ...
                                @if($sh->type=='series')
                                <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.series', $sh->slug)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                                @else
                                <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.show', $sh->slug)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                                @endif
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card h-100 d-flex flex-column">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.series', $trending->slug)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.show', $trending->slug)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                            @endif
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card h-100 d-flex flex-column">
                        ...
                        <div class="card-body">
                            ...
                            @if($rec->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.series', $rec->slug)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('taekwondo.show', $rec->slug)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @endif
