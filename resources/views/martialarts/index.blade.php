    ...
    <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            <div class="caption" style="margin-top: -25%; margin-left: 5%;">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('martialarts.series', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('martialarts.show', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
