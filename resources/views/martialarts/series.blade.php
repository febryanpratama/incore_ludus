...
<div class="container-fluid d-pg2">
    <div class="container">
        ...
        <div class="row text-center prefnext">
            @if($previousArticle)
            <div class="col-4">
                <a href="{{ route('martialarts.series', $previousArticle->id) }}" class="previous btn btn-outline-secondary">Previous</a>
            </div>
            @else
            <div class="col-4">
            </div>
            @endif
            <div class="col-4">@if($previousArticle) Page {{ $previousPage+1 }} 
                @elseif($nextArticle) Page {{ $nextPage-1 }}
                @else Page 1 @endif</div>
            @if($nextArticle)
            <div class="col-4">
                <a href="{{ route('martialarts.series', $nextArticle->id) }}" class="next btn btn-outline-secondary">Next</a>
            </div>
            @else
            <div class="col-4">
            </div>
