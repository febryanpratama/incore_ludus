    ...
    <div class="container">
        ...
        <div class="row text-center prefnext">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <a href="{{ route('martialarts.series', $previousArticle->slug) }}" class="previous btn btn-outline-secondary">Previous</a>
            </div>
            @else
            <div class="col-lg-4 col-md-4 col-sm-4">
            </div>
            ...
            @if($nextArticle)
            <div class="col-lg-4 col-md-4 col-sm-4">
                <a href="{{ route('martialarts.series', $nextArticle->slug) }}" class="next btn btn-outline-secondary">Next</a>
            </div>
            @else
            <div class="col-lg-4 col-md-4 col-sm-4">
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="card h-100 d-flex flex-column">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('martialarts.series', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('martialarts.show', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                        @endif
