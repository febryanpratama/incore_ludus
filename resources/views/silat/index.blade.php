        ...
        <div class="row">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-4">
                        <p>EXPLORE NEWS ABOUT pencak silat ON LUDUS. YOU'LL GET THE LATEST INFORMATION HERE.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <p>About Pencak Silat News</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('silat.viewall') }}" type="button" class="btn btn-outline-dark bt1">View All</a>
    <form class="d-flex" role="search" method="GET" action="{{ route('silat.index') }}">
        ...
        @else
            ...
            <div class="col mt-3">
                <div class="card">
                        ...
                        <a href="{{route('silat.series', $article->id)}}">
                        @else
                        <a href="{{route('silat.show', $article->id)}}">
                        @endif
                        ...
                        <div class="card-body">
                            ...
                            @if($article->type=='series')
                            <a href="{{route('silat.series', $article->id)}}" class="badge text-bg-success">{{$article->type}}</a>
                            @else
                            <a href="{{route('silat.show', $article->id)}}" class="badge text-bg-success">{{$article->type}}</a>
                            @endif
                            ...
                            @if($article->type=='series')
                            <h5 class="card-title"><a href="{{route('silat.series', $article->id)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a href="{{route('silat.show', $article->id)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                            @endif
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('silat.viewall') }}" type="button" class="btn btn-outline-dark bt3">View All</a>
  </div>
</nav>
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('silat.viewall') }}" type="button" class="btn btn-outline-dark bt2">View All</a>
  </div>
</nav>
                ...
                <div class="col-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if($rec->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('silat.series', $rec->artikel_id)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('silat.show', $rec->artikel_id)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @endif
