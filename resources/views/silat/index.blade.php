  ...
  <div class="container-fluid">
    <div class="row w-100">
        ...
        <div class="col-3 col-md-2 col-sm-3">
            <a href="{{ route('silat.viewall') }}" type="button" class="btn btn-outline-dark p-1">View All</a>
        </div>
    </div>
  </div>
</nav>
    ...
    <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            <div class="caption" style="margin-top: -25%; margin-left: 5%;">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('silat.series', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('silat.show', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
