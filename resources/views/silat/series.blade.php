    ...
    <div class="container">
        ...
        <div class="row text-center prefnext">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <a href="{{ route('silat.series', $previousArticle->slug) }}" class="previous btn btn-outline-secondary">Previous</a>
            </div>
            @else
            <div class="col-lg-4 col-md-4 col-sm-4">
            </div>
            ...
            @if($nextArticle)
            <div class="col-lg-4 col-md-4 col-sm-4">
                <a href="{{ route('silat.series', $nextArticle->slug) }}" class="next btn btn-outline-secondary">Next</a>
            </div>
            @else
            <div class="col-lg-4 col-md-4 col-sm-4">
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="card h-100 d-flex flex-column">
                    ...
                    <div class="card-body">
                        ...
                        @if($rec->type=='series')
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('silat.series', $rec->slug)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('silat.show', $rec->slug)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                        @endif
