...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <form class="d-flex" role="search" method="GET" action="{{ route('football.index') }}">
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('football.viewall') }}" type="button" class="btn btn-outline-dark bt3">View All</a>
  </div>
</nav>
    ...
    <div class="row">
        <div class="col-7">
            ...
            <div class="caption">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('football.series', $highlightPost->artikel_id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('football.show', $highlightPost->artikel_id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            @if($sh->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('football.series', $sh->artikel_id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('football.show', $sh->artikel_id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @endif
            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('football.series', $trending->artikel_id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('football.show', $trending->artikel_id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @endif
