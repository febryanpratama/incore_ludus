...
<div class="container-fluid d-pg2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <img src="{{ asset('storage/images_download/'.$article->imag2) }}" alt="{{$article->highlight1}}">
                    </div>
                    @endif
        ...
        <div class="row text-center prefnext">
            @if($previousArticle)
            <div class="col-4">
                <a href="{{ route('volley.series', $previousArticle->id) }}" class="previous btn btn-outline-secondary">Previous</a>
            </div>
            @else
            <div class="col-4">
            </div>
            ...
            @if($nextArticle)
            <div class="col-4">
                <a href="{{ route('volley.series', $nextArticle->id) }}" class="next btn btn-outline-secondary">Next</a>
            </div>
            @else
            <div class="col-4">
            </div>
