    ...
    <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            <div class="caption" style="margin-top: -25%; margin-left: 5%;">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            @if($sh->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $sh->id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $sh->id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @endif
    ...
    <div class="row">
        ...
        @else 
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card">
                    <img src="{{asset('images_download/'.$trending->id.'.png')}}" class="card-img-top" alt="{{$trending->headlineUtamaArtikel}}">
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $trending->id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $trending->id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @endif
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if($rec->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $rec->artikel_id)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $rec->artikel_id)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @endif
