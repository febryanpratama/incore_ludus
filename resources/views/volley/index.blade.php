            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <p class="fs-5 text-muted mt-3">EXPLORE NEWS ABOUT VOLLEY ON LUDUS. YOU'LL GET THE LATEST INFORMATION HERE.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <p class="responsive-text text-uppercase">About Volley News</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
  ...
  <div class="container-fluid">
    <div class="row w-100">
        ...
        <div class="col-3 col-md-2 col-sm-3">
            <a href="{{ route('volley.viewall') }}" type="button" class="btn btn-outline-dark p-1">View All</a>
        </div>
    </div>
  </div>
</nav>
            ...
            @foreach ($articles as $article)
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 mt-3">
                    <div class="card h-100 d-flex flex-column">
                            ...
                            <a href="{{route('volley.series', $article->slug)}}">
                            @else
                            <a href="{{route('volley.show', $article->slug)}}">
                            @endif
                            ...
                            <div class="card-body">
                                ...
                                @if($article->type=='series')
                                <a href="{{route('volley.series', $article->slug)}}" class="badge text-bg-success">{{$article->type}}</a>
                                @else
                                <a href="{{route('volley.show', $article->slug)}}" class="badge text-bg-success">{{$article->type}}</a>
                                @endif
                                ...
                                @if($article->type=='series')
                                <h5 class="card-title"><a href="{{route('volley.series', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                                @else
                                <h5 class="card-title"><a href="{{route('volley.show', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                                @endif
        ...
        <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            @else 
                ...
                <div class="caption" style="margin-top: -25%; margin-left: 5%;">
                    ...
                    <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $highlightPost->slug)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                    @else
                    <h1 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $highlightPost->slug)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                    @endif
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach($sideHighlight as $sh)
                            ...
                            <li class="list-group-item">
                                ...
                                @if($sh->type=='series')
                                <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $sh->slug)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                                @else
                                <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $sh->slug)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                                @endif
        ...
        @else 
            @foreach($trendingPosts as $trending)
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card h-100 d-flex flex-column">
                        <div class="ratio ratio-4x3">
                        <img src="{{asset('images_download/'.$trending->slug.'.png')}}" class="card-img-top object-fit-cover w-100 h-100" style="object-position: center;" alt="{{$trending->headlineUtamaArtikel}}">
                        </div>
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $trending->slug)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $trending->slug)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                            @endif
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card h-100 d-flex flex-column">
                        ...
                        <div class="card-body">
                            ...
                            @if($rec->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.series', $rec->slug)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('volley.show', $rec->slug)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @endif
