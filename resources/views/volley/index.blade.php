...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <form class="d-flex" role="search" method="GET" action="{{ route('volley.index') }}">
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('volley.viewall') }}" type="button" class="btn btn-outline-dark bt3">View All</a>
  </div>
</nav>
    ...
    <div class="row">
        <div class="col-7">
            ...
            <div class="caption">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('volley.series', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('volley.show', $highlightPost->id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
...
<div class="container-fluid pg-4">
    <div class="row">
        ...
        @else 
            ...
            <div class="col-4">
                <div class="card">
                    <img src="{{asset('storage/images_download/'.$trending->id.'.png')}}" class="card-img-top" alt="{{$trending->headlineUtamaArtikel}}">
                    <div class="card-body">
