            ...
            <div class="col-sm-8 col-md-8 p-0">
                <div id="carouselExampleCaptions" class="carousel slide">
                    <div class="carousel-inner">
                        ...
                        <p></p>
                        @else 
                            @if($footballTranding->image1!==null || $footballTranding->headlineUtamaArtikel!==null || $footballTranding->paragraf1!==null)
                        ...
                        @else 
                            @foreach($footballs as $fb)
                                @if($fb->image1!==null || $fb->headlineUtamaArtikel!==null || $fb->paragraf1!==null)
                ...
                <div class="row">
                    ...
                    @else 
                        @foreach($badmintons as $bm)
                            @if($bm->image1!==null || $bm->headlineUtamaArtikel!==null || $bm->paragraf1!==null)
                ...
                <div class="row">
                    ...
                    @else 
                        @foreach($baskets as $bas)
                            @if($bas->image1!==null || $bas->headlineUtamaArtikel!==null || $bas->paragraf1!==null)
                                <div class="col-12 col-sm-6 col-md-4 mb-3 mt-4">
                                    <div class="card h-100">
                                    @if($bas->type=='series')
                ...
                <div class="row">
                    ...
                    @else 
                        @foreach($martialarts as $mar)
                            @if($mar->image1!==null || $mar->headlineUtamaArtikel!==null || $mar->paragraf1!==null)
