    ...
    <div class="container">
        ...
        <div class="row text-center prefnext">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <a href="{{ route('karate.series', $previousArticle->slug) }}" class="previous btn btn-outline-secondary">Previous</a>
            </div>
            @else
            <div class="col-lg-4 col-md-4 col-sm-4">
            </div>
            ...
            @if($nextArticle)
            <div class="col-lg-4 col-md-4 col-sm-4">
                <a href="{{ route('karate.series', $nextArticle->slug) }}" class="next btn btn-outline-secondary">Next</a>
            </div>
            @else
            <div class="col-lg-4 col-md-4 col-sm-4">
            </div>
