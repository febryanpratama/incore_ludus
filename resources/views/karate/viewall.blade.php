...
<div class="container-fluid viewall">
    <form class="d-flex" role="search" method="GET" action="{{ route('karate.viewrecommendation') }}">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 mt-3 mb-4">
                <div class="card h-100 d-flex flex-column">
                        ...
                        <div class="card-body">
                            ...
                            @if($article->type=='series')
                            <h5 class="card-title"><a href="{{route('badminton.series', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a href="{{route('badminton.show', $article->slug)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                            @endif
