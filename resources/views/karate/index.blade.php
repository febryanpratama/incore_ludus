        ...
        <div class="row">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-4">
                        <p>EXPLORE NEWS ABOUT Karate ON LUDUS. YOU'LL GET THE LATEST INFORMATION HERE.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <p>About Karate News</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('karate.viewall') }}" type="button" class="btn btn-outline-dark bt1">View All</a>
    <form class="d-flex" role="search" method="GET" action="{{ route('karate.index') }}">
        ...
        @else
            ...
            <div class="col mt-3">
                <div class="card">
                        ...
                        <a href="{{route('karate.series', $article->id)}}">
                        @else
                        <a href="{{route('karate.show', $article->id)}}">
                        @endif
                        ...
                        <div class="card-body">
                            ...
                            @if($article->type=='series')
                            <a href="{{route('karate.series', $article->id)}}" class="badge text-bg-success">{{$article->type}}</a>
                            @else
                            <a href="{{route('karate.show', $article->id)}}" class="badge text-bg-success">{{$article->type}}</a>
                            @endif
                            ...
                            @if($article->type=='series')
                            <h5 class="card-title"><a href="{{route('karate.series', $article->id)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a href="{{route('karate.show', $article->id)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                            @endif
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('karate.viewall') }}" type="button" class="btn btn-outline-dark bt3">View All</a>
  </div>
</nav>
    ...
    <div class="row">
        <div class="col-7">
            ...
            <div class="caption">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('karate.series', $highlightPost->artikel_id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('karate.show', $highlightPost->artikel_id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            @if($sh->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('karate.series', $sh->artikel_id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('karate.show', $sh->artikel_id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @endif
...
<div class="container-fluid pg-4">
    <div class="row">
        ...
        @else 
            ...
            <div class="col-4">
                <div class="card">
                    <img src="{{ asset('storage/images_download/'.$trending->image1) }}" class="card-img-top" alt="{{$trending->headlineUtamaArtikel}}">
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('karate.series', $trending->artikel_id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('karate.show', $trending->artikel_id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @endif
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('karate.viewall') }}" type="button" class="btn btn-outline-dark bt2">View All</a>
  </div>
</nav>
                ...
                <div class="col-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if($rec->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('karate.series', $rec->artikel_id)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @else
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('karate.show', $rec->artikel_id)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                            @endif
