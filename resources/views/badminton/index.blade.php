                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            @if($sh->type=='series')
                            <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.series', $sh->id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                            @else
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.series', $trending->id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                        @else
