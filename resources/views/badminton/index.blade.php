        ...
        <div class="col mt-3">
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if($article->type=='series')
                        <a href="{{route('badminton.series', $article->id)}}" class="badge text-bg-success">{{$article->type}}</a>
                        @else
                        <a href="{{route('badminton.show', $article->id)}}" class="badge text-bg-success">{{$article->type}}</a>
                        @endif
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="{{ route('badminton.viewhighlight') }}" type="button" class="btn btn-outline-dark bt1">View All</a>
    <form class="d-flex" role="search">
      <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
      <button class="btn btn-outline-success" type="submit">
        <svg width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" class="DocSearch-Search-Icon"><path d="M14.386 14.386l4.0877 4.0877-4.0877-4.0877c-2.9418 2.9419-7.7115 2.9419-10.6533 0-2.9419-2.9418-2.9419-7.7115 0-10.6533 2.9418-2.9419 7.7115-2.9419 10.6533 0 2.9419 2.9418 2.9419 7.7115 0 10.6533z" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    <div class="row">
        <div class="col-7">
            ...
            <div class="caption">
                ...
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('badminton.series', $highlightPost->artikel_id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @else
                <h1 class="card-title"><a class="text-decoration-none text-white" href="{{route('badminton.show', $highlightPost->artikel_id)}}">{{$highlightPost->headlineUtamaArtikel}}</a></h1>
                @endif
            ...
            <div class="card">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        ...
                        @if($sh->type=='series')
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.series', $sh->artikel_id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.show', $sh->artikel_id)}}">{{$sh->headlineUtamaArtikel}}</a></h5>
                        @endif
        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.series', $trending->artikel_id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                    @else
                    <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.show', $trending->artikel_id)}}">{{$trending->headlineUtamaArtikel}}</a></h5>
                    @endif
        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($rec->type=='series')
                    <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.series', $rec->artikel_id)}}">{{$rec->headlineUtamaArtikel}}</a></h5>
                    @else
