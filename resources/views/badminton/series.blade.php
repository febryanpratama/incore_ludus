...
<div class="container-fluid d-pg2">
    <div class="container">
        ...
        <div class="row text-center prefnext">
            @if($previousArticle)
            <div class="col-4">
                <a href="{{ route('badminton.series', $previousArticle->id) }}" class="previous btn btn-outline-secondary">Previous</a>
            </div>
            @else
            <div class="col-4">
            </div>
            ...
            @if($nextArticle)
            <div class="col-4">
                <a href="{{ route('badminton.series', $nextArticle->id) }}" class="next btn btn-outline-secondary">Next</a>
            </div>
            @else
            <div class="col-4">
            </div>
            ...
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.series', $article->id)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                        @else
                        <h5 class="card-title"><a class="text-decoration-none text-black" href="{{route('badminton.show', $article->id)}}">{{$article->headlineUtamaArtikel}}</a></h5>
                        @endif
